...
- [x] **§6 Screen streaming** — behind the `screen-stream` feature:
  ...
  - [x] ABI→binary asset resolution (`MinicapAssets::resolve`) and `MinicapOptions`
        display/rotation constructors; rotation restart documented (stop + restart).
